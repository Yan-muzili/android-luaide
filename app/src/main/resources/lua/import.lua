...
local function env_import(env)
    ...
    append(packages, 'com.yan.luaide.')
...
local LuaAsyncTask = luajava.bindClass("com.yan.luaide.LuaAsyncTask")
local LuaThread = luajava.bindClass("com.yan.luaide.LuaThread")
local LuaTimer = luajava.bindClass("com.yan.luaide.LuaTimer")
