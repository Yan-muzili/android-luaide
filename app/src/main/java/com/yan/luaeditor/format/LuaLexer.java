...
import static com.yan.luaeditor.format.LuaTokenTypes.AND;
import static com.yan.luaeditor.format.LuaTokenTypes.ASSIGN;
import static com.yan.luaeditor.format.LuaTokenTypes.AT;
import static com.yan.luaeditor.format.LuaTokenTypes.BAD_CHARACTER;
import static com.yan.luaeditor.format.LuaTokenTypes.BIT_AND;
import static com.yan.luaeditor.format.LuaTokenTypes.BIT_LTLT;
import static com.yan.luaeditor.format.LuaTokenTypes.BIT_OR;
import static com.yan.luaeditor.format.LuaTokenTypes.BIT_RTRT;
import static com.yan.luaeditor.format.LuaTokenTypes.BIT_TILDE;
import static com.yan.luaeditor.format.LuaTokenTypes.BLOCK_COMMENT;
import static com.yan.luaeditor.format.LuaTokenTypes.BREAK;
import static com.yan.luaeditor.format.LuaTokenTypes.CASE;
import static com.yan.luaeditor.format.LuaTokenTypes.COLON;
import static com.yan.luaeditor.format.LuaTokenTypes.COMMA;
import static com.yan.luaeditor.format.LuaTokenTypes.CONCAT;
import static com.yan.luaeditor.format.LuaTokenTypes.CONTINUE;
import static com.yan.luaeditor.format.LuaTokenTypes.DEFAULT;
import static com.yan.luaeditor.format.LuaTokenTypes.DEFER;
import static com.yan.luaeditor.format.LuaTokenTypes.DIV;
import static com.yan.luaeditor.format.LuaTokenTypes.DO;
import static com.yan.luaeditor.format.LuaTokenTypes.DOC_COMMENT;
import static com.yan.luaeditor.format.LuaTokenTypes.DOT;
import static com.yan.luaeditor.format.LuaTokenTypes.DOUBLE_COLON;
import static com.yan.luaeditor.format.LuaTokenTypes.DOUBLE_DIV;
import static com.yan.luaeditor.format.LuaTokenTypes.ELLIPSIS;
import static com.yan.luaeditor.format.LuaTokenTypes.ELSE;
...
import static com.yan.luaeditor.format.LuaTokenTypes.FOR;
import static com.yan.luaeditor.format.LuaTokenTypes.FUNCTION;
import static com.yan.luaeditor.format.LuaTokenTypes.GE;
import static com.yan.luaeditor.format.LuaTokenTypes.GETN;
import static com.yan.luaeditor.format.LuaTokenTypes.GOTO;
import static com.yan.luaeditor.format.LuaTokenTypes.GT;
import static com.yan.luaeditor.format.LuaTokenTypes.IF;
import static com.yan.luaeditor.format.LuaTokenTypes.IN;
import static com.yan.luaeditor.format.LuaTokenTypes.LAMBDA;
import static com.yan.luaeditor.format.LuaTokenTypes.LBRACK;
import static com.yan.luaeditor.format.LuaTokenTypes.LCURLY;
import static com.yan.luaeditor.format.LuaTokenTypes.LE;
import static com.yan.luaeditor.format.LuaTokenTypes.LEF;
import static com.yan.luaeditor.format.LuaTokenTypes.LOCAL;
import static com.yan.luaeditor.format.LuaTokenTypes.LONG_STRING;
import static com.yan.luaeditor.format.LuaTokenTypes.LPAREN;
import static com.yan.luaeditor.format.LuaTokenTypes.LT;
import static com.yan.luaeditor.format.LuaTokenTypes.MEAN;
import static com.yan.luaeditor.format.LuaTokenTypes.MINUS;
import static com.yan.luaeditor.format.LuaTokenTypes.MOD;
import static com.yan.luaeditor.format.LuaTokenTypes.MULT;
import static com.yan.luaeditor.format.LuaTokenTypes.NAME;
import static com.yan.luaeditor.format.LuaTokenTypes.NE;
import static com.yan.luaeditor.format.LuaTokenTypes.NEW_LINE;
import static com.yan.luaeditor.format.LuaTokenTypes.NIL;
import static com.yan.luaeditor.format.LuaTokenTypes.NOT;
import static com.yan.luaeditor.format.LuaTokenTypes.NUMBER;
import static com.yan.luaeditor.format.LuaTokenTypes.OR;
import static com.yan.luaeditor.format.LuaTokenTypes.PLUS;
import static com.yan.luaeditor.format.LuaTokenTypes.RBRACK;
import static com.yan.luaeditor.format.LuaTokenTypes.RCURLY;
import static com.yan.luaeditor.format.LuaTokenTypes.REGION;
import static com.yan.luaeditor.format.LuaTokenTypes.REPEAT;
import static com.yan.luaeditor.format.LuaTokenTypes.RETURN;
import static com.yan.luaeditor.format.LuaTokenTypes.RPAREN;
import static com.yan.luaeditor.format.LuaTokenTypes.SEMI;
import static com.yan.luaeditor.format.LuaTokenTypes.SHEBANG;
import static com.yan.luaeditor.format.LuaTokenTypes.SHEBANG_CONTENT;
import static com.yan.luaeditor.format.LuaTokenTypes.SHORT_COMMENT;
import static com.yan.luaeditor.format.LuaTokenTypes.STRING;
import static com.yan.luaeditor.format.LuaTokenTypes.SWITCH;
import static com.yan.luaeditor.format.LuaTokenTypes.THEN;
import static com.yan.luaeditor.format.LuaTokenTypes.TRUE;
import static com.yan.luaeditor.format.LuaTokenTypes.UNTIL;
import static com.yan.luaeditor.format.LuaTokenTypes.WHEN;
import static com.yan.luaeditor.format.LuaTokenTypes.WHILE;
import static com.yan.luaeditor.format.LuaTokenTypes.WHITE_SPACE;
...
public class LuaLexer {
  ...
  public String nexttext() throws IOException {
    LuaTokenTypes token = advance();
    if (token != null) {
      return yytext();
    }
    return null;
  }
  public LuaTokenTypes peek() throws IOException {
    // 保存当前状态
    int savedStartRead = zzStartRead;
    int savedCurrentPos = zzCurrentPos;
    int savedMarkedPos = zzMarkedPos;
    int savedEndRead = zzEndRead;
    int savedLexicalState = zzLexicalState;
    int savedYyline = yyline;
    int savedYychar = yychar;
    int savedYycolumn = yycolumn;
    boolean savedAtBOL = zzAtBOL;
    boolean savedAtEOF = zzAtEOF;
    boolean savedEOFDone = zzEOFDone;
    int savedFinalHighSurrogate = zzFinalHighSurrogate;
    int savedNBrackets = nBrackets;

    // 尝试获取下一个标记
    LuaTokenTypes nextToken = advance();

    // 恢复状态
    zzStartRead = savedStartRead;
    zzCurrentPos = savedCurrentPos;
    zzMarkedPos = savedMarkedPos;
    zzEndRead = savedEndRead;
    zzLexicalState = savedLexicalState;
    yyline = savedYyline;
    yychar = savedYychar;
    yycolumn = savedYycolumn;
    zzAtBOL = savedAtBOL;
    zzAtEOF = savedAtEOF;
    zzEOFDone = savedEOFDone;
    zzFinalHighSurrogate = savedFinalHighSurrogate;
    nBrackets = savedNBrackets;
