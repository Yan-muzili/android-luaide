...
public class ActivitySet extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        itemList.add(new SetListAdapter.ItemModel("常规","常规IDE配置"));
        itemList.add(new SetListAdapter.ItemModel("编辑器","配置你的编辑器"));
        ...
        itemAdapter.setOnItemClickListener(new SetListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                switch (itemList.get(position).getTitle()){
                    case "常规":
                        startActivity(new Intent(ActivitySet.this,General_Settings.class));
                        break;
                    case "编辑器":
                        startActivity(new Intent(ActivitySet.this,Editor_Settings.class));
                        break;
                }
            }
        });
